...
class Metaclass_AddTwoInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('my_own_srv')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_own_srv.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from my_own_srv.srv._add_two_ints import AddTwoInts_Request as Request
    from my_own_srv.srv._add_two_ints import AddTwoInts_Response as Response
